export const DataViewOperationsBySignType: Record<string, DataViewOperations> =
    {
        Signed: {
...
export interface DataViewOperations {
...
export type DataViewOperationType = keyof DataViewOperations;
